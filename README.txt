POUR LANCER L'APPLICATION (Sous NetBeans) :

1) Créer une librairie, y ajouter tous les .jar trouvable dans le dossier lib.
2) Clique droit sur librairies, ajouter la librairie créée.
3) Clique droit sur le projet, propriétés, librairies, ajouter la librarie dans Classpath, puis dans l'onglet Run, faire de même dans Modulepath.
4) Toujours dans propriétés, dans Run cette fois-ci, ajouter la ligne suivante : 
	-Djava.library.path="lib/"
5) Vous pouvez Clean & Build le projet et le lancer.
